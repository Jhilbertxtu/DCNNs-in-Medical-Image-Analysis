...
def train_and_predict(use_existing):
  ...
  imgs_train = np.load(cm.workingPath.training3DSet_path + 'trainImages_%04d.npy' % (i)).astype(np.float32)
  imgs_mask_train = np.load(cm.workingPath.training3DSet_path + 'trainMasks_%04d.npy' % (i)).astype(np.float32)
