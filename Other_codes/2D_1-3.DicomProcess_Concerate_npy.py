...
if axis_process == "Axial":
  ...
  final_images = np.ndarray([num_images, cm.img_rows_3d, cm.img_cols_3d, 1], dtype=np.int16)
  final_masks = np.ndarray([num_images, cm.img_rows_3d, cm.img_cols_3d, 3], dtype=np.int8)
