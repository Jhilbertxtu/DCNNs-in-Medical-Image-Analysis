...
#                                                                                      #
# 1. Dicom Process with 3D Single Patch                                                #
#                                                                                      #
# created by                                                                           #
# Shuai Chen                                                                           #
# PhD student                                                                          #
...
final_masks = np.ndarray([sum(vol_slices), 512, 512], dtype=np.int8)
...
for num_vol in range(0, len(vol_slices)):
  num_patches = int(vol_slices[num_vol] / slices)
  if num_vol>0:
...
tubes = int(final_images_crop_save.shape[0])
...
i = 0
np.save(cm.workingPath.training3DSet_path + 'trainImages_%04d.npy' % (i), final_images_crop_save_last)
np.save(cm.workingPath.training3DSet_path + 'trainMasks_%04d.npy' % (i), final_masks_crop_save_last)
